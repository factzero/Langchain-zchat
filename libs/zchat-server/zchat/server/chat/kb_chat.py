...
from zchat.server.agent.tools_factory.search_internet import search_engine
from zchat.server.api_server.api_schemas import OpenAIChatOutput
from zchat.server.chat.utils import History
from zchat.server.knowledge_base.kb_service.base import KBServiceFactory
from zchat.server.knowledge_base.kb_doc_api import search_docs, search_temp_docs
from zchat.server.knowledge_base.utils import format_reference
from zchat.server.utils import (wrap_done, get_ChatOpenAI, get_default_llm,
...
async def kb_chat(query: str = Body(..., description="用户输入", examples=["你好"]),
    ...
    async def knowledge_base_chat_iterator() -> AsyncIterable[str]:
        try:
            ...
            # Enable langchain-zchat to support langfuse
            import os
