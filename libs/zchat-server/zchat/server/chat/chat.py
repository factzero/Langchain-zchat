...
from zchat.server.agent.agent_factory.agents_registry import agents_registry
from zchat.server.api_server.api_schemas import OpenAIChatOutput
from zchat.server.callback_handler.agent_callback_handler import (
    AgentExecutorAsyncIteratorCallbackHandler,
    AgentStatus,
)
from zchat.server.chat.utils import History
from zchat.server.memory.conversation_db_buffer_memory import (
...
async def chat(
    ...
    async def chat_iterator() -> AsyncIterable[OpenAIChatOutput]:
        try:
            ...
            # Enable langchain- to support langfuse
            import os
