...
from zchat.server.knowledge_base.kb_doc_api import DocumentWithVSId
from zchat.server.pydantic_v1 import BaseModel, Extra
from zchat.server.utils import CustomBaseTool
...
def regist_tool(
    *args: Any,
    ...
    def wrapper(def_func: Callable) -> CustomBaseTool:
        t = CustomBaseTool.from_function(
            func=def_func,
        )
        _parse_tool(t)
        return t
