...
from zchat.settings import Settings, XF_MODELS_TYPES
from zchat.server.pydantic_v2 import BaseModel, Field
...
def get_config_platforms() -> Dict[str, Dict]:
    ...
    """
    platforms = [m for m in Settings.model_settings["MODEL_PLATFORMS"]]
